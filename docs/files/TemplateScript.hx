...
// AFTER strumTime use ?value3:String, to 6 (?value6:String) in the function to make it work!
...
// BEFORE strumTime use value1:String, to 6 (value6:String) in the function to make it work! ()

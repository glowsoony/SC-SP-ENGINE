package scfunkin.objects.graphics.audio.visualize;

import flixel.group.FlxSpriteGroup.FlxTypedSpriteGroup;
import lime.utils.Int16Array;
import scfunkin.objects.graphics.audio.visualize.PolygonSpectogram.VISTYPE;
import scfunkin.backend.data.audio.visualize.VisShit;
import scfunkin.backend.data.audio.visualize.VisShit.CurAudioInfo;

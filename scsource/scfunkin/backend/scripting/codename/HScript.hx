...
class HScript extends Script
{
  ...
  public override function onCreate(path:String)
  {
    ...
    scfunkin.backend.scripting.codename.GlobalScript.call("onScriptCreated", [this, "hscript"]);
    loadFromString(code);
  }
  ...
  private function importFailedCallback(cl:Array<String>):Bool
  {
    ...
    for (hxExt in scfunkin.utils.CoolUtil.haxeExtensions)
    {
  ...
  private function _errorHandler(error:Error)
  {
    ...
    #if HSCRIPT_ALLOWED
    if (scfunkin.states.PlayState.instance == FlxG.state) scfunkin.states.PlayState.instance.addTextToDebug('$fn, $err', FlxColor.RED, 16);
    #end
  }

...
class SupportBETAFunctions
{
  ...
  public static function implement(funk:scfunkin.backend.scripting.psych.FunkinLua)
  {
    ...
    funk.set("setActorX", function(x:Int, id:String) {
      var shit:Dynamic = LuaUtil.getObjectDirectly(id);
      shit.x = x;
    });
    ...
    funk.set("setActorVelocityX", function(x:Int, id:String, ?bg:Bool = false) {
      if (bg) PlayState.instance.stage.swagBacks[id].velocity.x = x;
        ...
        LuaUtil.getActorByName(id).velocity.x = x;
    });
    ...
    funk.set("setActorAlpha", function(alpha:Float, id:String, ?bg:Bool = false) {
      if (bg) PlayState.instance.stage.swagBacks[id].alpha = alpha;
        ...
        LuaUtil.getActorByName(id).alpha = alpha;
    });
    ...
    funk.set("setActorVisibility", function(visible:Bool, id:String, ?bg:Bool = false) {
      if (bg) PlayState.instance.stage.swagBacks[id].visible = visible;
        ...
        LuaUtil.getActorByName(id).visible = visible;
    });

    funk.set("setActorY", function(y:Int, id:String, ?bg:Bool = false) {
      LuaUtil.getActorByName(id).y = y;
    });
    ...
    funk.set("setActorScaleXY", function(scaleX:Float, scaleY:Float, id:String) {
      LuaUtil.getActorByName(id).setGraphicSize(Std.int(LuaUtil.getActorByName(id).width * scaleX), Std.int(LuaUtil.getActorByName(id).height * scaleY));
    });

    funk.set("setActorFlipX", function(flip:Bool, id:String) {
      LuaUtil.getActorByName(id).flipX = flip;
    });

    funk.set("setActorFlipY", function(flip:Bool, id:String) {
      LuaUtil.getActorByName(id).flipY = flip;
    });

    funk.set("setActorColorRGB", function(id:String, color:String) {
      var actor:FlxSprite = LuaUtil.getActorByName(id);
    ...
    funk.set("setActorScroll", function(x:Float, y:Float, id:String) {
      var actor = LuaUtil.getActorByName(id);
      if (LuaUtil.getActorByName(id) != null)
      {
    ...
    funk.set("setActorColor", function(id:String, r:Int, g:Int, b:Int, alpha:Int = 255) {
      if (LuaUtil.getActorByName(id) != null)
      {
        Reflect.setProperty(LuaUtil.getActorByName(id), "color", FlxColor.fromRGB(r, g, b, alpha));
      }
    });
    ...
    funk.set("getActorY", function(id:String, ?bg:Bool = false) {
      if (bg) return PlayState.instance.stage.swagBacks[id].y;
        ...
        return LuaUtil.getActorByName(id).y;
    });
    ...
    funk.set("tweenColor", function(vars:String, duration:Float, initColor:FlxColor, finalColor:FlxColor, ease:String, ?tag:String) {
      ...
      if (itemExam != null)
      {
        if (tag != null)
        {
          ...
          FlxTween.color(itemExam, duration, initColor, finalColor, {ease: scfunkin.utils.GenericUtil.getTweenEaseByString(ease)});
      }
      else
    ...
    funk.set("enablePurpleMiss", function(id:String, toggle:Bool) {
      LuaUtil.getActorByName(id).doMissThing = toggle;
    });
    ...
    funk.set("tweenPos", function(id:String, toX:Int, toY:Int, time:Float, onComplete:String) {
      FlxTween.tween(LuaUtil.getActorByName(id), {x: toX, y: toY}, time,
        {
          ease: FlxEase.linear,
          onComplete: function(flxTween:FlxTween) {
            if (onComplete != '' && onComplete != null)
    ...
    funk.set("tweenPosXAngle", function(id:String, toX:Int, toAngle:Float, time:Float, onComplete:String) {
      FlxTween.tween(LuaUtil.getActorByName(id), {x: toX, angle: toAngle}, time,
        {
          ease: FlxEase.linear,
          onComplete: function(flxTween:FlxTween) {
            if (onComplete != '' && onComplete != null)
    ...
    funk.set("tweenPosYAngle", function(id:String, toY:Int, toAngle:Float, time:Float, onComplete:String) {
      FlxTween.tween(LuaUtil.getActorByName(id), {y: toY, angle: toAngle}, time,
        {
          ease: FlxEase.linear,
          onComplete: function(flxTween:FlxTween) {
            if (onComplete != '' && onComplete != null)
    ...
    funk.set("tweenAngle", function(id:String, toAngle:Int, time:Float, onComplete:String) {
      FlxTween.tween(LuaUtil.getActorByName(id), {angle: toAngle}, time,
        {
          ease: FlxEase.linear,
          onComplete: function(flxTween:FlxTween) {
            if (onComplete != '' && onComplete != null)
    ...
    funk.set("tweenFadeIn", function(id:String, toAlpha:Float, time:Float, onComplete:String) {
      FlxTween.tween(LuaUtil.getActorByName(id), {alpha: toAlpha}, time,
        {
          ease: FlxEase.circIn,
          onComplete: function(flxTween:FlxTween) {
            if (onComplete != '' && onComplete != null)
    ...
    funk.set("tweenFadeOutOneShot", function(id:String, toAlpha:Float, time:Float) {
      FlxTween.tween(LuaUtil.getActorByName(id), {alpha: toAlpha}, time, {type: FlxTweenType.ONESHOT});
    });
    ...
    funk.set("addClipRect", function(obj:String, x:Float, y:Float, width:Float, height:Float) {
      final object:Dynamic = LuaUtil.getObjectLoop(obj);
      if (object != null)
      {
    ...
    funk.set("setClipRectAngle", function(obj:String, degrees:Float) {
      final daRect:FlxRect = LuaUtil.getVarInArray(LuaUtil.getPropertyLoop([obj, 'clipRect']), 'clipRect');
      if (daRect != null)
      {
        daRect.getRotatedBounds(degrees);
        final object:FlxSprite = LuaUtil.getObjectLoop(obj);
    ...
    funk.set("objectColorTransform", function(obj:String, color:String) {
      var spr:Dynamic = LuaUtil.getObjectDirectly(obj);
    ...
    funk.set("getArrayLength", function(obj:String) {
      var shit:Dynamic = Reflect.getProperty(LuaUtil.getTargetInstance(), obj);
    ...
    funk.set("getMapLength", function(obj:String) {
      ...
      var shit:Map<String, Dynamic> = Reflect.getProperty(LuaUtil.getTargetInstance(), obj);

      if (split.length > 1)
      {
        shit = Reflect.getProperty(Type.resolveClass(split[0]), split[1]);

        if (shit == null) shit = LuaUtil.getVarInArray(LuaUtil.getPropertyLoop(split), split[split.length - 1]);
      }
    ...
    funk.set("animationSwap", function(char:String, anim1:String, anim2:String) {
      var shit = LuaUtil.getObjectDirectly(char);
    ...
    funk.set("getDominantColor", function(sprite:String) {
      var shit:Dynamic = LuaUtil.getObjectDirectly(sprite);
    ...
    funk.set("changeIcon", function(obj:String, iconName:String) {
      final object:HealthIcon = LuaUtil.getObjectLoop(obj);
      if (object != null)
      {
    ...
    funk.set("arrayContains", function(obj:String, value:Dynamic) {
      var leArray:Dynamic = Reflect.getProperty(LuaUtil.getTargetInstance(), obj);
    ...
    funk.set("changeGroupMemberHue", function(obj:String, index:Int, hue:Int) {
      var shit:Dynamic = Reflect.getProperty(LuaUtil.getTargetInstance(), obj)[index];

      if (Std.isOfType(Reflect.getProperty(LuaUtil.getTargetInstance(), obj),
        FlxTypedGroup)) shit = Reflect.getProperty(LuaUtil.getTargetInstance(), obj).members[index];
    ...
    funk.set("makeLuaCharacter", function(tag:String, character:String, isPlayer:Bool = false, flipped:Bool = false, characterType:String = 'OTHER') {
      LuaUtil.makeLuaCharacter(tag, character, isPlayer, flipped, characterType);
    });
    ...
    funk.set("changeLuaCharacter", function(tag:String, character:String, characterType:String = 'OTHER') {
      ...
      if (shit != null) LuaUtil.makeLuaCharacter(tag, character, shit.isPlayer, shit.flipMode, characterType);
    });
    ...
    funk.set("stopIdle", function(id:String, stopped:Bool) {
      ...
      cast(LuaUtil.getActorByName(id), Character).stopIdle = stopped;
    });
    ...
    funk.set("characterDance", function(character:String) {
      ...
      if (MusicBeatState.variableMap(character).exists(character))
      {
        ...
        cast(LuaUtil.getObjectDirectly(character), Character).dance();
    });

    // New Stuff
    funk.set("doFunction", LuaUtil.doFunction);

    funk.set("changeDadCharacter", LuaUtil.changeDadCharacter);
    funk.set("changeBoyfriendCharacter", LuaUtil.changeBoyfriendCharacter);
    funk.set("changeGFCharacter", LuaUtil.changeGFCharacter);
    funk.set("changeMomCharacter", LuaUtil.changeMomCharacter);
    funk.set("changeStage", PlayState.instance.changeStage);
    funk.set("changeDadCharacterBetter", LuaUtil.changeDadCharacterBetter);
    funk.set("changeBoyfriendCharacterBetter", LuaUtil.changeBoyfriendCharacterBetter);
    funk.set("changeGFCharacterBetter", LuaUtil.changeGFCharacterBetter);
    funk.set("changeMomCharacterBetter", LuaUtil.changeMomCharacterBetter);

    // the auto stuff
    funk.set("changeBFAuto", LuaUtil.changeBFAuto);

    // cuz sometimes i type boyfriend instead of bf
    funk.set("changeBoyfriendAuto", LuaUtil.changeBFAuto);

    funk.set("changeDadAuto", LuaUtil.changeDadAuto);

    funk.set("changeGFAuto", LuaUtil.changeGFAuto);

    funk.set("changeMomAuto", LuaUtil.changeMomAuto);

    funk.set("changeStageOffsets", LuaUtil.changeStageOffsets);
    ...
    funk.set("cameraSnap", function(camera:String, x:Float, y:Float) {
      ...
      var camPosition:FlxObject = new FlxObject();
      camPosition.setPosition(x, y);
      LuaUtil.cameraFromString(camera).focusOn(camPosition.getPosition());
    });
  }
  ...
  static public function makeNewIcon(tag:String, character:String, player:Bool = false)
  {
    ...
    LuaUtil.getTargetInstance().add(leSprite);

...
class TextFunctions
{
  public static function implement(funk:FunkinLua)
  {
    ...
    funk.set("setTextString", function(tag:String, text:String) {
      ...
      final obj:FlxText = LuaUtil.getObjectLoop(tag);
      if (obj != null)
      {
        obj.text = text;
        return true;
    ...
    funk.set("addLuaText", function(tag:String) {
      final obj:FlxText = LuaUtil.getObjectDirectly(tag);
      if (obj != null) LuaUtil.getTargetInstance().add(obj);
    });
    funk.set("removeLuaText", function(tag:String, destroy:Bool = true) {
      ...
      final instance:Dynamic = CustomSubstate.instance != null ? CustomSubstate.instance : LuaUtil.getTargetInstance();

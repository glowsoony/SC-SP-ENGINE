...
import scfunkin.objects.ui.scripting.ModchartAnimateSprite;
...
class FunkinLua
{
  ...
  public static var lua_Shaders:Map<String, scfunkin.shaders.data.ShaderBase> = [];
  public static var lua_Custom_Shaders:Map<String, scfunkin.shaders.codename.CustomShader> = [];
  ...
  public function new(scriptName:String, instance:FileInstance, preloading:Bool = false, notScriptName:String = null)
  {
    ...
    if (preloading) // only the necessary functions for preloading are included
    {
      ...
      set("makeAnimatedLuaSprite", function(tag:String, image:String, x:Float, y:Float, spriteType:String = "auto") {
        ...
        LuaUtil.loadFrames(leSprite, image, spriteType);
    ...
    else
    {
      ...
      set("setVar", function(varName:String, value:Dynamic, ?type:String = "Custom") {
        MusicBeatState.getVariables(type).set(varName, scfunkin.backend.scripting.psych.functions.ReflectionFunctions.parseInstances(value));
        return value;
      });
      ...
      set("loadGraphic", function(variable:String, image:String, ?gridX:Int = 0, ?gridY:Int = 0) {
        final spr:FlxSprite = LuaUtil.getObjectLoop(variable);
      ...
      set("getObjectOrder", function(obj:String, ?group:String = null) {
        final leObj:FlxBasic = LuaUtil.getObjectLoop(obj);
        if (leObj != null)
        {
          if (group != null)
          {
            final groupOrArray:Dynamic = Reflect.getProperty(LuaUtil.getTargetInstance(), group);
          ...
          final groupOrArray:Dynamic = CustomSubstate.instance != null ? CustomSubstate.instance : LuaUtil.getTargetInstance();
      ...
      set("startTween", function(tag:String, vars:String, values:Any = null, duration:Float, ?options:Any = null) {
        final itemExam:Dynamic = LuaUtil.tweenPrepare(tag, vars);
        if (itemExam != null)
        {
          if (values != null)
          {
      ...
      set("doTweenZoom", function(tag:String, camera:String, value:Dynamic, duration:Float, ?ease:String = 'linear') {
        return oldTweenFunction(tag, LuaUtil.returnCameraName(camera), {zoom: value}, duration, ease, 'doTweenZoom');
      });
      ...
      set("doTweenColor", function(tag:String, vars:String, targetColor:String, duration:Float, ?ease:String = 'linear') {
        ...
        if (itemExam != null)
        {
          ...
          if (tag != null)
          {
            ...
            FlxTween.color(itemExam, duration, curColor, CoolUtil.colorFromString(targetColor), {ease: GenericUtil.getTweenEaseByString(ease)});
        }
        else
      ...
      set("cancelTween", function(tag:String) LuaUtil.cancelTween(tag));
      ...
      set("cancelTimer", function(tag:String) LuaUtil.cancelTimer(tag));
      ...
      set("cameraShake", function(camera:String, intensity:Float, duration:Float) {
        LuaUtil.cameraFromString(camera).shake(intensity, duration);
      });
      set("cameraFlash", function(camera:String, color:String, duration:Float, forced:Bool) {
        LuaUtil.cameraFromString(camera).flash(CoolUtil.colorFromString(color), duration, null, forced);
      });
      set("cameraFade", function(camera:String, color:String, duration:Float, forced:Bool, ?fadeOut:Bool = false) {
        LuaUtil.cameraFromString(camera).fade(CoolUtil.colorFromString(color), duration, fadeOut, null, forced);
      });
      ...
      set("getMouseX", function(?camera:String = 'game') {
        var cam:FlxCamera = LuaUtil.cameraFromString(camera);
      ...
      set("getMidpointX", function(variable:String) {
        final obj:FlxObject = LuaUtil.getObjectLoop(variable);
      ...
      set("getGraphicMidpointX", function(variable:String) {
        final obj:FlxSprite = LuaUtil.getObjectLoop(variable);
      ...
      set("getScreenPositionX", function(variable:String, ?camera:String = 'game') {
        final obj:FlxObject = LuaUtil.getObjectLoop(variable);
        final cam:FlxCamera = LuaUtil.cameraFromString(camera);
      ...
      set("addAnimation", function(obj:String, name:String, frames:Array<Int>, framerate:Float = 24, loop:Bool = true) {
        return LuaUtil.addAnimByIndices(obj, name, null, frames, framerate, loop);
      });

      set("addAnimationByIndices", function(obj:String, name:String, prefix:String, indices:Any, framerate:Float = 24, loop:Bool = false) {
        return LuaUtil.addAnimByIndices(obj, name, prefix, indices, framerate, loop);
      });
      ...
      set("playActorAnimation", function(obj:String, anim:String, force:Bool = false, reverse:Bool = false, ?frame:Int = 0) {
        ...
        final char:Character = LuaUtil.getObjectDirectly(obj);
        if (char != null)
      ...
      set("playAnim", function(obj:String, name:String, ?forced:Bool = false, ?reverse:Bool = false, ?startFrame:Int = 0) {
        var obj:Dynamic = LuaUtil.getObjectDirectly(obj);
      ...
      set("playAnimOld", function(obj:String, name:String, ?forced:Bool = false, ?reverse:Bool = false, ?startFrame:Int = 0) {
        if (LuaUtil.getObjectDirectly(obj) != null)
        {
          var luaObj:FlxSprite = LuaUtil.getObjectDirectly(obj);
      ...
      set("setScrollFactor", function(obj:String, scrollX:Float, scrollY:Float) {
        final object:FlxObject = LuaUtil.getObjectLoop(obj);
      ...
      set("addLuaSprite", function(tag:String, place:Dynamic = false) {
        ...
        else
        {
          ...
          final instance = LuaUtil.getTargetInstance();
          if (place == 2 || place == true) instance.add(mySprite);
          else
          {
            if (game == null || !game.isDead) instance.insert(instance.members.indexOf(LuaUtil.getLowestCharacterPlacement()), mySprite);
            else
      ...
      set("removeLuaSprite", function(tag:String, destroy:Bool = true, ?group:String = null) {
        LuaUtil.findToDestroy(tag, destroy, group);
      });
      ...
      set("setObjectCamera", function(obj:String, camera:String = 'game') {
        ...
        if (object != null)
        {
          object.cameras = [LuaUtil.cameraFromString(camera)];
          return;
        }
      ...
      set("screenCenter", function(obj:String, pos:String = 'xy') {
        final spr:FlxObject = LuaUtil.getObjectLoop(obj);
        if (spr != null)
        {
      ...
      set("objectsOverlap", function(obj1:String, obj2:String) {
        ...
        {
          final obj:FlxBasic = LuaUtil.getObjectLoop(tag);
      ...
      set("startVideo",
        function(videoFile:String, type:String = 'mp4', ?midSong:Bool = false, ?canSkip:Bool = true, ?forMidSong:Bool = false, ?shouldLoop:Bool = false,
          ...
          if (FileSystem.exists(Paths.video(videoFile, type)))
          {
            ...
            game.videoCutscene = game.startVideo(videoFile, type, forMidSong, canSkip, shouldLoop, playOnLoad, adjustSize);
            return true;
          }
          else
          {
      ...
      #if flxanimate scfunkin.backend.scripting.psych.functions.FlxAnimateFunctions.implement(this); #end
      ...
      scfunkin.states.substates.scripting.CustomSubstate.implement(this);
  ...
  public function call(func:String, args:Array<Dynamic>):Dynamic
  {
    ...
    try
    {
      if (lua == null) return LuaUtil.Function_Continue;
      ...
      if (result == null) result = LuaUtil.Function_Continue;
  ...
  public function get(var_name:String, type:Dynamic):Dynamic
  {
    ...
    {
      var result = LuaUtil.convert(result, type);
      return result;
    }
  }
  ...
  {
    var target:Dynamic = LuaUtil.tweenPrepare(tag, vars);
    if (target != null)
    {
      if (tag != null)
      {
  ...
  function noteTweenFunction(tag:String, note:Int, data:Dynamic, duration:Float, ease:String)
  {
    ...
    var strumLineNotes:scfunkin.objects.note.StrumLine = PlayState.instance.opponentStrums;

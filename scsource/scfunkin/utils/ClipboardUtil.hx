...
class ClipboardUtil
{
   ...
   */
  public static function addUpdateListener(callback:Void->Void, once:Bool = false, ?priority:Int = 0):Void
   ...
   */
  public static function removeUpdateListener(callback:Void->Void):Void

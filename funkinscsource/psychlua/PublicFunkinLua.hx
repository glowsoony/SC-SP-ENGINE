...
//   public static var place:Dynamic = null;
//   #if HSCRIPT_ALLOWED
...
//   public function new(newInstance:Dynamic = PlayState.instance, scriptName:String, instance:FileInstance, preloading:Bool = false, notScriptName:String = null)
//   {
//     final times:Float = Date.now().getTime();
//     final game:Dynamic = newInstance;
//     this.place = game;
//     if (game != null)
//     {
...
//     if (instance == PLAYSTATE || isStageLua)
//     {
//       if (game != null)
//       {
//         if (!isStageLua) GlobalUtils.reflectGet(game, 'luaArray').push(this);
//         else
//           GlobalUtils.reflectGet(game.stage, 'luaArray').push(this);
//       }
//     }
//     else if (GlobalUtils.isReflect(true, game, 'luaArray')) GlobalUtils.reflectGet(game, 'luaArray').push(this);
//     #if MODS_ALLOWED
...
//     if (game != null && instance == PLAYSTATE) @:privateAccess
//     {
//       final trueGame:PlayState = cast game;
//       final curSection:SwagSection = PlayState.SONG.notes[trueGame.curSection];
//       // PlayState variables
//       set('curSection', trueGame.curSection);
//       set('curBeat', trueGame.curBeat);
//       set('curStep', trueGame.curStep);
//       set('curDecBeat', trueGame.curDecBeat);
//       set('curDecStep', trueGame.curDecStep);
//       set('score', trueGame.songScore);
//       set('misses', trueGame.songMisses);
//       set('hits', trueGame.songHits);
//       set('combo', trueGame.combo);
//       set('comboOp', trueGame.comboOp);
//       set('rating', trueGame.ratingPercent);
//       set('ratingName', trueGame.ratingName);
//       set('ratingFC', trueGame.ratingFC);
//       set('totalPlayed', trueGame.totalPlayed);
//       set('totalNotesHit', trueGame.totalNotesHit);
...
//       set('playBFSing', true);
//       // Gameplay settings
//       set('healthGainMult', trueGame.healthGain);
//       set('healthLossMult', trueGame.healthLoss);
//       #if FLX_PITCH
//       set('playbackRate', trueGame.playbackRate);
//       #else
//       set('playbackRate', 1);
//       #end
//       set('guitarHeroSustains', trueGame.guitarHeroSustains);
//       set('instakillOnMiss', trueGame.instakillOnMiss);
//       set('botPlay', trueGame.cpuControlled);
//       set('practice', trueGame.practiceMode);
//       set('modchart', trueGame.notITGMod);
//       set('opponent', trueGame.opponentMode);
//       set('showCaseMode', trueGame.showCaseMode);
//       set('holdsActive', trueGame.holdsActive);
//       for (i in 0...4)
//       {
...
//       }
//       // Default character
//       set('defaultBoyfriendX', trueGame.BF_X);
//       set('defaultBoyfriendY', trueGame.BF_Y);
//       set('defaultOpponentX', trueGame.DAD_X);
//       set('defaultOpponentY', trueGame.DAD_Y);
//       set('defaultGirlfriendX', trueGame.GF_X);
//       set('defaultGirlfriendY', trueGame.GF_Y);
//       set('defaultMomX', trueGame.MOM_X);
//       set('defaultMomY', trueGame.MOM_Y);
//       set('boyfriendName', trueGame.boyfriend != null ? trueGame.boyfriend.curCharacter : PlayState.SONG != null ? PlayState.SONG.characters.player : 'bf');
//       set('dadName', trueGame.dad != null ? trueGame.dad.curCharacter : PlayState.SONG != null ? PlayState.SONG.characters.opponent : 'dad');
//       set('gfName', trueGame.gf != null ? trueGame.gf.curCharacter : PlayState.SONG != null ? PlayState.SONG.characters.girlfriend : 'bf');
//       set('momName', trueGame.mom != null ? trueGame.mom.curCharacter : PlayState.SONG != null ? PlayState.SONG.characters.secondOpponent : 'mom');
...
//       set("getRunningScripts", function() {
//         var runningScripts:Array<String> = [];
//         if (GlobalUtils.isReflect(true, game, 'luaArray'))
//         {
//           final luaArray:Array<FunkinLua> = GlobalsUtils.reflectGet(game, 'luaArray');
//           for (script in luaArray)
//             runningScripts.push(script.scriptName);
//         }
//         if (isStageLua && GlobalUtils.isReflect(true, game.stage, 'luaArray'))
//         {
//           final luaArray:Array<FunkinLua> = GlobalsUtils.reflectGet(game.stage, 'luaArray');
//           for (script in luaArray)
//             runningScripts.push(script.scriptName);
//         }
//         if (GlobalUtils.isReflect(true, game, 'hscriptArray'))
//         {
//           final hscriptArray:Array<HScript> = GlobalsUtils.reflectGet(game, 'hscriptArray');
//           for (script in hscriptArray)
//             runningScripts.push(script.origin);
//         }
//         if (isStageLua && GlobalUtils.isReflect(true, game.stage, 'hscriptArray'))
//         {
//           final hscriptArray:Array<HScript> = GlobalsUtils.reflectGet(game.stage, 'hscriptArray');
//           for (script in hscriptArray)
//             runningScripts.push(script.origin);
//         }
//         return runningScripts;
...
//         if (game == MusicBeatState.getState())
//         {
//           final state:MusicBeatState = cast game;
//           state.setOnScripts(varName, arg, exclusions);
//         }
//         else if (game == MusicBeatState.getState().subStaten)
//         {
//           final state:MusicBeatSubState = cast game;
//           state.setOnScripts(varName, arg, exclusions);
//         }
//       });
...
//         final spr:FlxSprite = LuaUtils.getObjectLoop(variable);
//         final gX = gridX == null ? 0 : gridX;
//         final gY = gridY == null ? 0 : gridY;
...
//         final leObj:FlxBasic = LuaUtils.getObjectLoop(obj);
//         if (leObj != null)
//         {
//           if (group != null)
//           {
//             final groupOrArray:Dynamic = Reflect.getProperty(LuaUtils.getTargetInstance(), group);
...
//           else
//           {
//             final groupOrArray:FlxState = LuaUtils.getTargetInstance();
//             groupOrArray.remove(leObj, true);
//             groupOrArray.insert(position, leObj);
//           }
//           return;
...
//                     if (myOptions.onUpdate != null && game != null && game == MusicBeatState.getState())
//                     {
//                       final state:MusicBeatState = cast game;
//                       state.callOnLuas(myOptions.onUpdate, [tag, vars]);
//                     }
//                     else if (myOptiosn.onUpdate != null && game != null && game == MusicBeatState.getState().subState)
//                     {
//                       final state:MusicBeatSubState = cast game;
//                       state.callOnLuas(myOptions.onUpdate, [tag, vars]);
//                     }
...
//                     if (myOptions.onStart != null && game != null && game == MusicBeatState.getState())
//                     {
//                       final state:MusicBeatState = cast game;
//                       state.callOnLuas(myOptions.onStart, [tag, vars]);
//                     }
//                     else if (myOptiosn.onStart != null && game != null && game == MusicBeatState.getState().subState)
//                     {
//                       final state:MusicBeatSubState = cast game;
//                       state.callOnLuas(myOptions.onStart, [tag, vars]);
//                     }
...
//                     if (myOptions.onComplete != null && game != null && game == MusicBeatState.getState())
//                     {
//                       final state:MusicBeatState = cast game;
//                       state.callOnLuas(myOptions.onComplete, [tag, vars]);
//                     }
//                     else if (myOptiosn.onComplete != null && game != null && game == MusicBeatState.getState().subState)
//                     {
//                       final state:MusicBeatSubState = cast game;
//                       state.callOnLuas(myOptions.onComplete, [tag, vars]);
//                     }
...
//                     {
//                       final state:MusicBeatState = cast game;
//                       state.callOnLuas(myOptions.onUpdate, [null, vars]);
//                     }
//                     else if (myOptiosn.onUpdate != null && game != null && game == MusicBeatState.getState().subState)
//                     {
//                       final state:MusicBeatSubState = cast game;
...
//                     {
//                       final state:MusicBeatState = cast game;
//                       state.callOnLuas(myOptions.onStart, [null, vars]);
//                     }
//                     else if (myOptiosn.onStart != null && game != null && game == MusicBeatState.getState().subState)
//                     {
//                       final state:MusicBeatSubState = cast game;
...
//                     {
//                       final state:MusicBeatState = cast game;
//                       state.callOnLuas(myOptions.onComplete, [null, vars]);
//                     }
//                     else if (myOptiosn.onComplete != null && game != null && game == MusicBeatState.getState().subState)
//                     {
//                       final state:MusicBeatSubState = cast game;
...
//           if (tag != null)
//           {
//             MusicBeatState.getVariables("Tween").set(tag, FlxTween.color(itemExam, duration, curColor, newColor,
//               {
//                 ease: LuaUtils.getTweenEaseByString(ease),
//                 onComplete: function(twn:FlxTween) {
//                   MusicBeatState.getVariables("Tween").remove(tag);
//                   if (game != null && game == MusicBeatState.getState())
//                   {
//                     final state:MusicBeatState = cast game;
//                     state.callOnLuas('onTweenCompleted', [tag, vars]);
//                   }
//                   else if (game != null && game == MusicBeatState.getState().subState)
//                   {
//                     final state:MusicBeatSubState = cast game;
//                     state.callOnLuas('onTweenCompleted', [tag, vars]);
//                   }
...
//           {
//             final state:MusicBeatState = cast game;
//             state.callOnLuas('onTimerCompleted', [tag, tmr.loops, tmr.loopsLeft]);
//           }
//           else if (game != null && game == MusicBeatState.getState().subState)
//           {
//             final state:MusicBeatSubState = cast game;
...
//         if (instance != PLAYSTATE) return 0;
//         final trueGame:PlayState = cast game;
//         trueGame.songScore += value;
//         trueGame.RecalculateRating();
//         return value;
//       });
...
//         if (game == null) return;
//         if (instance != PLAYSTATE) return;
//         final trueGame:PlayState = cast game;
//         trueGame.cacheCharacter(name, superCache);
//       });
...
//           if (instance != PLAYSTATE) return;
//           final trueGame:PlayState = cast game;
//           trueGame.triggerEventLegacy(name, arg1, arg2, Conductor.songPosition, arg3, arg4, arg5, arg6);
//           return true;
//         });
...
//         if (instance != PLAYSTATE) return;
//         final trueGame:PlayState = cast game;
//         trueGame.triggerEvent(name, args, Conductor.songPosition);
//         return true;
//       });
...
//         }
//         else if (game == MusicBeatState.getState().subState)
//         {
//           final state:MusicBeatSubState = cast game;
//           game.persistentUpdate = false;
//         }
...
//         if (game == null) return false;
//         if (instance != PLAYSTATE) return false;
...
//         if (game == null) return "dad";
//         if (!GlobalUtils.isReflect(true, game, 'cameraTargeted')) return "dad";
//         if (GlobalUtils.reflectGet(game, 'cameraTargeted') == null) return "dad";
//         return GlobalUtils.reflectSet(game, 'cameraTargeted', target);
//       });
//       set('cameraGetTarget', function() {
//         if (game == null) return "dad";
//         if (!GlobalUtils.isReflect(true, game, 'cameraTargeted')) return "dad";
//         if (GlobalUtils.reflectGet(game, 'cameraTargeted') == null) return "dad";
//         return GlobalUtils.reflectGet(game, 'cameraTargeted');
//       });
...
//         if (game == null) return;
//         if (!GlobalUtils.isReflect(true, game, 'camFollow')) return;
//         if (GlobalUtils.reflectGet(game, 'camFollow') == null) return;
//         GlobalUtils.reflectGet(game, 'camFollow').setPosition(x, y);
//       });
...
//         if (!GlobalUtils.isReflect(true, game, 'camFollow')) return;
//         if (GlobalUtils.reflectGet(game, 'camFollow') == null) return;
//         GlobalUtils.reflectGet(game, 'camFollow').x += x;
//         GlobalUtils.reflectGet(game, 'camFollow').y += y;
//       });
//       set("getCameraScrollX", () -> FlxG.camera.scroll.x + FlxG.width / 2);
//       set("getCameraScrollY", () -> FlxG.camera.scroll.y + FlxG.height / 2);
//       set("getCameraFollowX", function():Float {
//         if (game == null) return 0;
//         if (!GlobalUtils.isReflect(true, game, 'camFollow')) return;
//         if (GlobalUtils.reflectGet(game, 'camFollow') == null) return;
//         return GlobalUtils.reflectGet(game, 'camFollow').x;
//       });
//       set("getCameraFollowY", function():Float {
//         if (game == null) return 0;
//         if (!GlobalUtils.isReflect(true, game, 'camFollow')) return;
//         if (GlobalUtils.reflectGet(game, 'camFollow') == null) return;
//         return GlobalUtils.reflectGet(game, 'camFollow').y;
//       });
...
//         final cam:FlxCamera = LuaUtils.cameraFromString(camera);
...
//         final obj:FlxObject = LuaUtils.getObjectLoop(variable);
...
//         final obj:FlxSprite = LuaUtils.getObjectLoop(variable);
...
//         {
//           case 'dad':
//             if (!GlobalUtils.isReflect(true, game, 'dad')) return;
//             if (GlobalUtils.reflectGet(game, 'gf') != null) GlobalUtils.reflectGet(game, 'dad').dance(forcedToIdle);
//           case 'gf' | 'girlfriend':
//             if (!GlobalUtils.isReflect(true, game, 'gf')) return;
//             if (GlobalUtils.reflectGet(game, 'gf') != null) GlobalUtils.reflectGet(game, 'dad').dance();
//           case 'mom':
//             if (!GlobalUtils.isReflect(true, game, 'mom')) return;
//             if (GlobalUtils.reflectGet(game, 'mom') != null) GlobalUtils.reflectGet(game, 'mom').dance();
//           default:
//             if (!GlobalUtils.isReflect(true, game, 'boyfriend')) return;
//             if (GlobalUtils.reflectGet(game, 'boyfriend') != null) GlobalUtils.reflectGet(game, 'boyfriend').dance();
//         }
//       });
...
//         final spr:FlxSprite = LuaUtils.getObjectLoop(obj);
...
//         final spr:FlxObject = LuaUtils.getObjectLoop(obj);
//         if (spr != null)
//         {
...
//         {
//           final obj:FlxBasic = LuaUtils.getObjectLoop(tag);
//           if (obj != null) objectsArray.push(obj);
//         }
...
//             if (hame != null && game == MusicBeatState.getState())
//             {
//               final state:MusicBeatState = cast game;
//               state.callOnLuas('onSoundFinished', [tag]);
//             }
//             else if (game != null && game == MusicBeatState.getState().subState)
//             {
//               final state:MusicBeatSubState = cast game;
...
//             onComplete: function(twn:FlxTween) {
//               MusicBeatState.getVariables("Tween").remove(tag);
//               if (place == MusicBeatState.getState())
//               {
//                 final state:MusicBeatState = cast place;
//                 state.callOnLuas('onTweenCompleted', [tag, vars]);
//               }
//               else if (place == MusicBeatState.getState().subState)
//               {
//                 final state:MusicBeatSubState = cast place;
//                 state.callOnLuas('onTweenCompleted', [tag, vars]);
//               }
//             }
//           }));
...
//             {
//               final state:MusicBeatState = cast place;
//               state.callOnLuas('onTweenCompleted', [tag]);
//             }
//             else if (place == MusicBeatState.getState().subState)
//             {
//               final state:MusicBeatSubState = cast place;

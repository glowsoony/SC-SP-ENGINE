...
class EventData
{
  ...
  public function getTypeValue(property:PropertyType, value:String, ?index:String = null):Dynamic
  {
    ...
    switch (property)
    {
      ...
      case STRING:
        return value;
      case COLOR:
        return CoolUtil.colorFromString(value);
    }
  }
